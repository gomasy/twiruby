...
module TwiRuby
  class OAuth < TwiRuby::Client
    def initialize(options = {})
      ...
      @req = Request.new(tokens, REST::BASE_URL)
    end
    ...
    def get_request_token(options = {})
      res = @req.post("/oauth/request_token", nil, options)
    ...
    def get_access_token(request_token, options = {})
      ...
      res = @req.post("/oauth/access_token", nil, options)
      Hash[URI::decode_www_form(res.body)].with_indifferent_access
    end
  end
end
